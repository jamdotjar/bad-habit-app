...
const GoogleIcon = ({ size }: { size: string | number }) => (
...
const GithubIcon = ({ size, color }: { size: string | number; color: string }) => (
    <svg fill={color} role="img" viewBox="0 0 24 24" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
...
const GoogleLoginButton = (props: any) => (
    <Button {...props} style={{ background: "white", color: "black", outline: "1px solid #e2e8f0" }}>
        <GoogleIcon size={24} />
        Log in with Google
    </Button>
);
...
const GithubLoginButton = (props: any) => (
    <Button {...props} style={{ background: "#333333", color: "white" }}>
